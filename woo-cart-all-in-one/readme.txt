...
[Try the Demo](http://new2new.com/?item=woocommerce-cart-all-in-one "Demo Cart All In One For WooCommerce") | [Documents](http://docs.villatheme.com/?item=woocommerce-cart-all-in-one "Documents") | [Premium version](https://villatheme.com/extensions/woocommerce-cart-all-in-one/) | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")

###Preview WooCommerce Cart All In One
[youtube https://youtu.be/jtOBUr6VvsE]
...
[GET PRO VERSION](https://villatheme.com/extensions/woocommerce-cart-all-in-one/) or [https://codecanyon.net/item/woocommerce-cart-all-in-one/30184317](https://villatheme.com/extensions/woocommerce-cart-all-in-one/)
...
2. Upload `woo-cart-all-in-one` to the `/wp-content/plugins/` directory
...
== Screenshots ==
1. Sidebar cart
2. Cart icon on frontend
3. Design on customize
...
2022.05.19 - version 1.1.8
- Updated: Update support class

2022.04.20 - version 1.1.7
- Updated: Update support class

2022.03.29 - version 1.1.6
- Updated: Update support class

2022.03.21 - version 1.1.5
- Updated: support class

2022.01.10 - version 1.1.4
- Updated: support class

2021.11.15 - version 1.1.3
- Fixed: Can not translate 'Coupon code' in the sidebar cart

2021.10.26 - version 1.1.2
- Added: New display style for the sidebar cart icon

2021.10.07 - version 1.1.1.0
- Fixed: Can not get list applied coupons

2021.07.31 - version 1.1.0.9
- Updated: support class

2021.06.26 - version 1.1.0.8
